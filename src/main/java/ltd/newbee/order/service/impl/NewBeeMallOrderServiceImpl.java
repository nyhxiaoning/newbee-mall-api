 ...
 * 版权所有，侵权必究！
 */
package ltd.newbee.order.service.impl;

import ltd.newbee.order.api.vo.NewBeeMallOrderDetailVO;
import ltd.newbee.order.api.vo.NewBeeMallOrderItemVO;
import ltd.newbee.order.api.vo.NewBeeMallOrderListVO;
import ltd.newbee.order.api.vo.NewBeeMallShoppingCartItemVO;
import ltd.newbee.common.*;
import ltd.newbee.order.dao.*;
import ltd.newbee.order.entity.*;
import ltd.newbee.user.entity.MallUser;
import ltd.newbee.user.entity.MallUserAddress;
import ltd.newbee.goods.dao.NewBeeMallGoodsMapper;
import ltd.newbee.goods.entity.NewBeeMallGoods;
import ltd.newbee.goods.entity.StockNumDTO;
import ltd.newbee.order.service.NewBeeMallOrderService;
import ltd.newbee.common.utils.BeanUtil;
import ltd.newbee.common.utils.NumberUtil;
import ltd.newbee.common.utils.PageQueryUtil;
import ltd.newbee.common.utils.PageResult;
