 ...
 * 版权所有，侵权必究！
 */
package ltd.newbee.user.api.admin;

import io.swagger.annotations.Api;
import ltd.newbee.user.api.param.AdminLoginParam;
import ltd.newbee.user.api.param.UpdateAdminNameParam;
import ltd.newbee.user.api.param.UpdateAdminPasswordParam;
...
import ltd.newbee.user.service.AdminUserService;
